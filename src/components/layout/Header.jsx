...
const TITLES = {
  ...
  '/social': { title: 'Social Dashboard', sub: 'Métricas das suas redes sociais em tempo real' },
  '/settings': { title: 'Configurações', sub: 'API keys, integrações e preferências' },
  '/authenticity': { title: 'Crítico de Autenticidade', sub: 'Analise a autenticidade do seu conteúdo' },
}
