...
export const PERSONAL_TEMAS_SUGESTOES = [
  {
    ...
    temas: [
      ...
      'As expressões e opiniões silenciosas da Naomi',
      'O relacionamento da Naomi com as visitas',
      'Como ela pede atenção sem fazer nenhum esforço',
      'O drama para tomar banho ou ir ao veterinário',
      'Momentos em que a Naomi parece uma pessoa',
      'A personalidade que ninguém percebe pelas fotos',
      'Os pequenos rituais que temos juntas',
    ],
  },
  {
